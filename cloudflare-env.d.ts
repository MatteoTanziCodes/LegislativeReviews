/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env staging --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: cf3dd7d1537e6bfe7a7a3219786d2e25)
...
declare namespace Cloudflare {
	interface Env {
		...
		env: string;
		WORKER_SELF_REFERENCE: Fetcher /* core-staging */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LEGISLATIVE_REVIEW_SUMMARY_KEY" | "LEGISLATIVE_REVIEW_DETAILS_KEY" | "CLAUDE_API_KEY" | "env">> {}
}
